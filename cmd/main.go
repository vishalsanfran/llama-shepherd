...
import (
	...
	"github.com/vishalsanfran/llama-shepherd/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8fae86d4.example.com",
	...
	if err := (&controller.LLMInferenceJobReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LLMInferenceJob")
		os.Exit(1)
	}
	...
	if err := (&controller.KVCachePoolReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KVCachePool")
		os.Exit(1)
	}
